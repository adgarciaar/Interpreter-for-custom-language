...
public class MoveBackwards implements ASTNode {
	
	private ASTNode numValue;
	private Car myCar;

	public MoveBackwards(ASTNode numValue, Car myCar) {
		super();
	...
	public Object execute(Map<String, Object> symbolTable) {
		...
		this.myCar.backwards( (float)this.numValue.execute(symbolTable) );
		return null;
	}
